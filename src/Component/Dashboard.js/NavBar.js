...
const NavBar = ({roar}) => {
    ...
    const URI = "http://localhost:4000/user/fetchuser"
    const URI2 = "http://localhost:4000/user/findoneuser"
    ...
    const [icon, seticon] = useState(roar)
    ...
    let date=new Date()
     const getShare =()=>{
        ...
        let data={
            ...
            location,
            Time:{date:date.getDate(),month:date.getMonth(),day:date.getDay() }
        }
                ...
                <div className='row card border  ' style={{ padding: "13px 0px" }}>
                    <div className='col-12  row'>
                        ...
                        <div className='col-lg-3 col-md-4 col-sm-5 row ms-2 mt-1 ms-lg-3' id='increase2'>
                            <Link to="/home" style={{cursor:"pointer"}}  onClick={()=>seticon("home")} className='col-2 '>
                                <img src={LogoS1} alt="istagram400" />
                            </Link>
                            <Link to="/message" className='col-2' style={{cursor:"pointer"}}    onClick={()=>seticon("message")}>
                                <img src={LogoS2} alt="istagram400" />
                            </Link>
                            <div className='col-2 ' style={{cursor:"pointer"}}  onClick={()=>seticon("uploadfile")}>
                                <img src={LogoS3} alt="istagram400" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{ cursor: "pointer" }} />
                            </div>
                            <Link to="/explore" className='col-2 ' style={{cursor:"pointer"}}  onClick={()=>seticon("explore")}>
                                <img src={LogoS4} alt="istagram400" className="" />
                            </Link>
                            <div className='col-2 cursor-focus' style={{cursor:"pointer"}} onClick={()=>seticon("follow")}><img src={LogoS5} alt="istagram400" className="" /></div>
                            <div className='col-2  '>
                                ...
                                {isOpen && (
                                    <div className='card shadow-sm px-3 ' style={{ position: "absolute", top: "64px", }} id="dropdown">
                                        <Link className='text-decoration-none text-dark mb-2' style={{ fontSize: "14px", padding: "4px 0px" }} to="/profile"><img src={profile} className="me-2" />Profile</Link>
                            ...
                            <div className="modal-body py-5">
                                <form id="form-file-upload" onDragEnter={handleDrag} onSubmit={(e) => e.preventDefault()}
                                    ...
                                    <div className=' text-center' style={{ padding: "40px 0px" }} onDragEnter={handleDrag}>
                                        ...
                                        <input type="file" id="file-upload2" onChange={(e) => uploadImageFromComputer(e)} />
                                            ...
                                            <div className='d-flex flex-row-reverse align-items-center ps-2 rounded-1' style={{ height: "105px", width: "100%", }}>
                                                {wantToMap.map((val, index) => (
                                                    <div className='d-flex align-items-center ' key={index} style={{ height: "90px", width: "100px", backgroundColor: "black" }} >
                                                        <img className='w-100 px-1 cursor-pointer' src={val.image} onClick={() => setimageWantToUpload(val.image)} height="100%" width="100%" alt={`uploadimagesfor${index}`} />
                                                    </div>
                                                ))}
                                            </div>
                                    ...
                                    <div className=' d-flex w-100 h-100' style={{ padding: "-2px 0px" }}>
                                        ...
                                        <div className='w-50 border border-0 border-start ps-2 ' style={{ overflowY: "scroll" }}>
                                            <div className='mb-3 ps-1'>
                                                <img src={currentUser.ProfilePic} width="35px" height="35px" className='rounded-circle' alt="" />
                                                <strong className='ms-1'>{currentUser.Fullname}</strong>
                                            </div>
                                            <div>
