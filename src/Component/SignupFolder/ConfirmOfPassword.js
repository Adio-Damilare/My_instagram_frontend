        ...
        <div className='col-lg-4 col-md-7 col-sm-10 mx-auto pt-4 mt-2 ' id='spaceMuch'>
          <div className='pt-4 card px-2'>
            ...
            <div className='text-center' style={{ marginTop: "-22px" }}>
              <b style={{ fontSize: "13px", fontWeight: "lighter" }}>{formik.values.Email}  <p style={{ fontSize: "14px", fontWeight: "lighter" }} className="text-decoration-none" > Resend Code</p></b>
            </div>
